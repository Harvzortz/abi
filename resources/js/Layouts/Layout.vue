<template>
  <div class="flex">
    ...
    <div class="flex flex-col w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        <h2 class="text-3xl font-semibold text-gray-800 dark:text-white">Ortega Harvy</h2>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            ...
            <div class="flex items-center px-4 -mx-2">
                <img class="object-cover mx-2 rounded-full h-9 w-9" src="https://scontent.fcrk2-1.fna.fbcdn.net/v/t1.0-9/68402639_2311834258885215_4265309842446483456_o.jpg?_nc_cat=107&ccb=1-3&_nc_sid=09cbfe&_nc_eui2=AeEJbLAVBJ4uLcaJRHdPsLLiij9BZZrZM_uKP0Flmtkz-1QYMvVBjuLtWOELluaqf0tH8_-dHezJSUxt9EgnhkR4&_nc_ohc=8k_DuUoaapAAX_WK9Yv&_nc_ht=scontent.fcrk2-1.fna&oh=664d21cbde365294156be9c30941c1b2&oe=6083576E" alt="avatar">
                <h4 class="mx-2 font-medium text-gray-800 dark:text-gray-200 hover:underline">Harvy</h4>
            </div>
        </div>
    </div>
      </div>
<div class="w-full bg-gray-100 flex-col">
    ...
    <nav class="bg-white shadow dark:bg-gray-800">
        <div class="container px-6 py-3 mx-auto md:flex">
            <div class="flex items-center justify-between">
                <div>
                    <a class="text-xl font-bold text-gray-800 dark:text-white md:text-2xl hover:text-gray-700 dark:hover:text-gray-300" href="#">Ortega Harvy</a>
                </div>
